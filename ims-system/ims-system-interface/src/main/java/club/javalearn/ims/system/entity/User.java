...
public class User implements Serializable {
     ...
     */
    @Id
    @GeneratedValue(strategy=GenerationType.TABLE,generator="user_sequences")
    @TableGenerator(name="user_sequences",allocationSize=1,initialValue=1,table="jpa_sequences")
    private Long userId;
